...
export const AUDIT: AuditEvent[] = [
  ...
  },
  {
    ...
    action: 'create_user',
    target: 'newanalyst',
    detail: 'Provisioned analyst role',
    src_ip: '10.20.4.10',
  },
  {
    audit_id: 'aud_99f03a',
  ...
  return {
    ...
    notes: [
      ...
      },
      {
        id: 'n2',
        author: 'senior.demo',
        author_role: 'senior_investigator',
    ...
    history: [
      ...
      },
      {
        ...
        actor_role: 'analyst',
        action: 'assigned',
        detail: 'Claimed by analyst.demo',
      },
      {
        id: 'h3',
        ts: '2026-06-30T03:00:00Z',
