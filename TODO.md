...
## 6. 🏗️ PLATFORM (41/41 tasks DONE — see prompts/06_PLATFORM.md) ✅
...
- **73 unit/contract tests pass · 26-svc compose validates · all demos green.** Two PRs-worth on branch `hawk-eye/platform`.
